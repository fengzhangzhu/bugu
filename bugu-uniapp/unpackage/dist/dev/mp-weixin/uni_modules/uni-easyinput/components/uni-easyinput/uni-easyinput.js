...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    L: common_vendor.o($options.onEyes),
    M: common_vendor.p({
    ...
    P: common_vendor.o(($event) => $options.onClickIcon("suffix")),
    Q: common_vendor.p({
    ...
    T: common_vendor.o($options.onClear),
    U: common_vendor.p({
      type: "clear",
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-abe12412"], ["__file", "D:/Project/Vue/Uniapp/bugu_uniapp-master/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);

...
const _sfc_main = {
  ...
  methods: {
    ...
    async publishQuestion(questionTitle, questionDetails, isAnony, imgs, videos, labelIds) {
      let res = await utils_request.request({
        data: {
          method: "POST",
          group: "question",
...
if (!Array) {
  ...
  (_easycom_uni_nav_bar2 + _easycom_uni_file_picker2 + _easycom_uni_tag2 + _easycom_uni_icons2 + _easycom_emoji2 + _easycom_uni_transition2 + _easycom_uni_search_bar2 + _easycom_uni_popup2)();
}
...
if (!Math) {
  (_easycom_uni_nav_bar + _easycom_uni_file_picker + _easycom_uni_tag + _easycom_uni_icons + _easycom_emoji + _easycom_uni_transition + _easycom_uni_search_bar + _easycom_uni_popup)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: $data.questionText,
    d: common_vendor.o((...args) => $options.onQuestionInput && $options.onQuestionInput(...args)),
    e: $data.questionDescription,
    f: common_vendor.o((...args) => $options.onTextareaInput && $options.onTextareaInput(...args)),
    g: $data.imageFiles.length > 0
  }, $data.imageFiles.length > 0 ? {
    h: common_vendor.o($options.onImageFilesSelect),
    i: common_vendor.o(($event) => $data.imageFiles = $event),
    j: common_vendor.p({
      fileMediatype: "image",
      mode: "grid",
      limit: "9",
    ...
    k: common_vendor.f($data.videoFiles, (item, index, i0) => {
      return {
        a: `video_${index}`,
        b: item.url,
        c: index
    ...
    l: common_vendor.f($data.labelSelect, (item, index, i0) => {
      return {
        a: item.id,
        b: "810eeb86-2-" + i0,
        c: common_vendor.p({
    ...
    m: $data.isShowAnonymity
  }, $data.isShowAnonymity ? {
    n: $data.isAnonymity == 1,
    o: common_vendor.o(($event) => $options.onSwitchClick())
  } : {}, {
    p: common_vendor.o(($event) => $options.onAddLabelClick()),
    q: common_vendor.o(($event) => $options.onImageIconClick()),
    r: common_vendor.o(($event) => $options.onCameraIconClick()),
    s: common_vendor.o(($event) => $options.onVideoIconClick()),
    t: common_vendor.o(($event) => $options.prepareBeforePublic()),
    v: $data.buttonIsLoading,
    w: common_vendor.o(($event) => _ctx.onEmojiPickerCloseClick()),
    x: common_vendor.p({
    ...
    y: common_vendor.o($options.setEmoj),
    z: common_vendor.p({
      ["mode-class"]: "slide-bottom",
      show: $data.showEmojiPicker
    }),
    A: common_vendor.o(($event) => $options.onSearchConfirm()),
    B: common_vendor.o(($event) => $data.labelSearchText = $event),
    C: common_vendor.p({
      placeholder: "\u641C\u7D22\u6807\u7B7E",
      cancelButton: "none",
    ...
    E: common_vendor.f($data.labels, (item, k0, i0) => {
      return {
        a: item.id,
        b: common_vendor.o(($event) => $options.onChooseLabelClick(item), item.id),
        c: "810eeb86-8-" + i0 + ",810eeb86-6",
        d: common_vendor.p({
    ...
    F: common_vendor.o(($event) => $options.onRefreshLabelClick()),
    G: common_vendor.sr("labelPopup", "810eeb86-6"),
    H: common_vendor.p({
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Project/Vue/Uniapp/bugu_uniapp-master/pages/publish/ask-questions/ask-questions.vue"]]);

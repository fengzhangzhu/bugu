...
const _sfc_main = {
  ...
  onReady() {
    ...
    let titleH = common_vendor.index.createSelectorQuery().select("#followed-scrollview");
  ...
  async onLoad() {
    ...
    let FOLLOWED_NUMBER_CHANGED = common_storageKeys.getFollowedNumberChangedKey(this.userInfo.id);
    common_vendor.index.setStorage({ key: FOLLOWED_NUMBER_CHANGED, data: 0 });
...
if (!Array) {
  ...
  const _easycom_follow_item2 = common_vendor.resolveComponent("follow-item");
  (_easycom_uni_nav_bar2 + _easycom_follow_item2)();
}
const _easycom_uni_nav_bar = () => "../../../uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar.js";
const _easycom_follow_item = () => "../../../components/follow-item/follow-item.js";
if (!Math) {
  (_easycom_uni_nav_bar + _easycom_follow_item)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.f($data.followsList, (item, k0, i0) => {
      return {
        a: item.id,
        b: "2cab1d9c-1-" + i0,
        c: common_vendor.p({
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Project/Vue/Uniapp/bugu_uniapp-master/pages/mine-secondary-page/follow-list/follow-list.vue"]]);
